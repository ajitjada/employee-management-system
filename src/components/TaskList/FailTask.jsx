  ...
  return (
    <div>
      <div className='flex flex-col shrink-0 bg-[#1e4d89] rounded-xl  h-100 w-90'>
            ...
            <h2 className='px-3 h-30 text-[#d5dde6] text-lg mt-5'>{data.taskDescription}</h2>
            <button className='bg-red-600 items-center justify-center py-2 mt-5 ml-10 mr-10 rounded-xl font-semibold text-xl  cursor-pointer '>Failed Task</button>
        </div>  
    </div>
  )
}

export default FaileTask
